sap.ui.define(
	...
	function (BaseObject, MessageType, ODataError) {
		 ...
		 * @public
		 */
		const ErrorHandler = BaseObject.extend("zpsr0120.errorhandler.ErrorHandler", {
				...
				case ErrorType.OData:
					{
						...
						if (typeof error === "object") {
							error.forEach(function (oErr) {
								let sType = oErr?.severity?.charAt(0).toUpperCase() + oErr?.severity?.slice(1) || "Error";
								if (sType === "Info") {
									sType = "Information";
								}
								aMessages.push({
