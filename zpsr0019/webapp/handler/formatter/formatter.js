sap.ui.define(["../helper/Validator", "sap/ui/core/format/NumberFormat"], function (Validator, NumberFormat) {
	...
	return {
		...
		/**
		 * Return date format Date Object to yyyyMMdd
		...
		/**
		 * Convert a Date object or date string to "yyyyMMdd"
		 * @param {Date|string} oDateInput
		 * @returns {string}
		 */
		dateInputFormatter: function (oDateInput) {
			if (!oDateInput) {
				return "";
			}
